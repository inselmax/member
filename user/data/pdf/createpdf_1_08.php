    ...
    <tr>
      <th>
        <table cellpadding="3" style="width: 190mm;">
          <tr>
            <th class="tit_head" align="right" style="width: 105mm;">若杉梅田ビル</th>　
    ...
    <tr>
      <td class="tbl_01" style="width: 80mm;">
        ...
        <td rowspan="2" align="center" style="width: 40mm; height: 31.5mm;">
            <img src="/member/user/data/pdf/sample/img08_01.jpg" style="height: 31.5mm;">
        </td>
...
<table border="0" cellspacing="0" cellpadding="2" style="width: 190mm;">
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">月曜～土曜&emsp;7:30～19:30&emsp;時間外・日曜・祝日・お盆・年末年始はセキュリティカードにて出入りは可能です。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">管理人常駐による警備（月曜～土曜&emsp;8:00～18:00実施、日祝は無）<br>ビル共用部防犯カメラ</td>
    </tr>
    <tr>
      <th style="width: 35mm;">〇鍵</th>
      <td style="width: 150mm;" colspan="2">初回は、シリンダーキー2本・夜間扉カードキー2枚を無料で貸与。<br>以降は、夜間扉カードキー１枚につき3,000円(税別)が必要となります。</td>
    </tr>
    <tr>
