...
if ( !empty($_POST['office_id']) && strlen($_POST['office_id']) == 7 ) {
  ...
  // 表看板掲載料
  $price_signboard = "15,000";

  // 火災保険料
  $price_fire = "21,760";

  // 駐車場
  $price_parkingMon = "22,000";
  $price_parkingDeposit = "44,000";
    ...
    <tr>
      <th>
        <table cellpadding="3" style="width: 190mm;">
          <tr>
            <th class="tit_head" align="right" style="width: 105mm;">若杉センタービル本館</th>　
    ...
    <tr>
      <td class="tbl_01" style="width: 80mm;">
        ...
        <td rowspan="2" align="center" style="width: 40mm; height: 31.5mm;">
            <img src="/member/user/data/pdf/sample/img01_01.jpg" style="height: 31.5mm;">
        </td>
...
<table border="0" cellspacing="0" cellpadding="2" style="width: 190mm;">
      ...
      <td style="width: 150mm;" colspan="2">
        <table class="b_border" style="width: 150mm;">
          <tr>
            ...
            <th align="left" style="width: 90mm;">円(非課税・2年)※目安になります。</th>
          </tr>
        </table>
      </td>
    </tr>
    ...
    <tr>
      <th style="width: 35mm;" rowspan="2">〇駐車場</th>
      <td style="width: 150mm;" colspan="2">
        <table class="b_border" style="width: 150mm;">
          <tr>
            <th align="left" style="width: 15mm;">＜月額＞</th>
            <td align="center" style="width: 30mm;">{$price_parkingMon}</td>
            <th align="left" style="width: 30mm;">円(税別)</th>
            <th align="left" style="width: 15mm;">＜保証金＞</th>
            <td align="center" style="width: 30mm;">{$price_parkingDeposit}</td>
            <th align="left" style="width: 30mm;">円(非課税)</th>
          </tr>
        </table>
      </td>
    </tr>
    <tr>
      <td style="width: 150mm;" colspan="2">「若杉センタービル別館駐車場」該当ビルより北側に徒歩1分&emsp;立体駐車場<br>
      入出庫可能時間&emsp;月曜～土曜&emsp;7:30～21:30&emsp;日曜・祝日・お盆・年末年始は入出庫不可<br>
      サイズ：高さ1,650㎜×車幅1,850㎜×全長5,050㎜ 重量1,600㎏</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">月曜～土曜 7:30～21:30&emsp;時間外・日曜・祝日・お盆・年末年始はセキュリティカードにて出入りは可能です。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">ビルマルチ空調（但し季節によって冷暖房切替を行います）※省エネ型空調機を使用</td>
    </tr>
    <tr>
      <th style="width: 35mm;">〇エレベーター</th>
      <td style="width: 150mm;" colspan="2">3基</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">初回は、シリンダーキー2本・セコムカードキー2枚を無料で貸与。以降は、セコムカードキー１枚につき2,000円(税別)が必要となります。貸室ドアカードキー1枚につき3,000円(税別)が必要となります。</td>
    </tr>
    <tr>
      <th style="width: 35mm;">〇交通アクセス</th>
      <td style="width: 150mm;" colspan="2">JR「大阪天満宮」駅&emsp;1号出口直結</td>
    </tr>
    <tr>
      <th style="width: 35mm;">〇館内での喫煙について</th>
      <td style="width: 150mm;" colspan="2">全館（室内含む）禁煙とさせて頂いております。電子タバコについても同様となりますので、ご注意ください。
      </td>
    </tr>
    <tr>
