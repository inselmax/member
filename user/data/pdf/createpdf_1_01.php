  ...
  <tr>
    <td style="width: 132mm;">
      <table cellpadding="3" style="width: 132mm;">
        <tr>
          <th class="tit_head" align="right" style="width: 65mm;">若杉センタービル本館</th>　
          ...
          <td class="dotborder">
            ...
            <table border="0" cellspacing="0" cellpadding="2" style="width: 132mm;">
              <tr>
                ...
                <img src="/member/user/data/pdf/sample/image01_01.jpg" style="height: 64mm;">
                </td>
            ...
            <table border="1" cellspacing="0" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>〒530-0044&emsp;大阪市北区東天満2丁目9番1号</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>JR東西線「大阪天満宮」駅9号出口より徒歩0分<br><span class="s_text">※他の沿線は『物件の図面』にて掲載</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              <tr>
                <th align="center" class="bg_gray" style="width: 33mm;">
                  <table cellpadding="0">
                    <tr>
                      <td>駐車場<span class="s_text">(若杉センタービル別館駐車場)</span></td>
                    </tr>
                  </table>
                </th>
                <td style="width: 49mm;">
                  <table style="width: 49mm;" cellpadding="4">
                    <tr>
                      <td align="left" style="width: 12mm;">月額</td>
                      <td class="l_text" align="center" style="width: 13mm;">{$price_parkingMon}</td>
                ...
                <td style="width: 49mm;">
                  <table style="width: 49mm;" cellpadding="4">
                    <tr>
                      <td align="left" style="width: 12mm;">保証金</td>
                      <td class="l_text" align="center" style="width: 13mm;">{$price_parkingDeposit}</td>
                      <td align="right" style="width: 19mm;">円&ensp;(非課税)</td>
                    </tr>
                  </table>
                </td>
              </tr>
        ...
        <tr>
          <td>
            <table style="width: 132mm;" cellpadding="0" cellspacing="1">
              <tr>
                <td class="s_text">※「若杉センタービル別館駐車場」該当ビルより北側に徒歩1分　立体駐車場<br>※入出庫可能時間　月曜～土曜　7:30～21:30 　日曜・祝日・お盆・年末年始は入出庫不可<br>※サイズ：高さ1,650㎜×車幅1,850㎜×全長5,050㎜ 重量1,600㎏</td>
              </tr>
            </table>
          </td>
        </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="1">
                    <tr>
                      <td align="left" style="width: 98mm;">3基</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="1">
                    <tr>
                      <td align="left" style="width: 101mm;">管理人常駐による警備（月曜～土曜8:00～18:00&emsp;日祝なし）</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="0">
                    <tr>
                      <td align="left" style="width: 98mm;">初回、貸室ドアカードキー２本・セコムカードキー２枚を無料で貸与<br><span class="s_text">※貸室ドアカードキー3,000円＋消費税／枚、追加セコムカードキー2,000円＋消費税／枚</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
