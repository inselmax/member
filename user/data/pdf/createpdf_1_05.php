  ...
  <tr>
    <td style="width: 132mm;">
      <table cellpadding="3" style="width: 132mm;">
        <tr>
          <th class="tit_head" align="right" style="width: 60mm;">若杉大阪駅前ビル</th>　
          <th class="tit_head" align="left" style="width: 38mm;">諸条件書</th>
          ...
          <td class="dotborder">
            ...
            <table border="0" cellspacing="0" cellpadding="2" style="width: 132mm;">
              <tr>
                ...
                <img src="/member/user/data/pdf/sample/image05_01.jpg" style="height: 63.5mm;">
                </td>
            ...
            <table border="1" cellspacing="0" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>〒530-0002&emsp;大阪市北区曽根崎新地2丁目3番13号
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>大阪メトロ四ツ橋線「西梅田」駅9番出口より徒歩2分<br><span class="s_text">※他の沿線は『物件の図面』にて掲載</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="0">
                    <tr>
                      <td align="left" style="width: 98mm;">月曜～土曜　7:30～20:00<br>時間外・日曜・祝日・お盆・年末年始は、セキュリティカードにて出入可能。<br>※引越は、「土曜日（祝日以外）」のみとなります。</td>
                    </tr>
                  </table>
                </td>
              </tr>
