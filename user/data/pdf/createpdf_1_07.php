            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="0">
                    <tr>
                      <td align="left" style="width: 98mm;">月曜～土曜　7:30～21:00（※開館は管理人、閉館は夜間巡回時。入居テナン<br>ト様が閉館作業いただける場合は変更可能）<br>日曜・祝日　10:00～22:00（※現在、入居テナント様が開閉されている為、<br>時間調整は可能）<br>※お盆・年末年始に関しては、終日閉館となります。<br>※引越は、「土曜日（祝日以外）」のみとなります。</td>
                    </tr>
                  </table>
                </td>
              </tr>
