    ...
    <tr>
      <th>
        <table cellpadding="3" style="width: 190mm;">
          <tr>
            <th class="tit_head" align="right" style="width: 105mm;">若杉東梅田ビル</th>　
    ...
    <tr>
      <td class="tbl_01" style="width: 80mm;">
        ...
        <td rowspan="2" align="center" style="width: 40mm; height: 31.5mm;">
            <img src="/member/user/data/pdf/sample/img07_01.jpg" style="height: 31.5mm;">
        </td>
...
<table border="0" cellspacing="0" cellpadding="2" style="width: 190mm;">
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">月曜～土曜&emsp;7:30～22:00（※現在、入居テナント様が開閉しているため、時間調整は可能）<br>日曜・祝日 10:00～22:00&emsp;※お盆・正月に関しては終日閉館となります。</td>
    </tr>
    <tr>
