  ...
  <tr>
    <td style="width: 132mm;">
      <table cellpadding="3" style="width: 132mm;">
        <tr>
          <th class="tit_head" align="right" style="width: 58mm;">若杉東梅田ビル</th>　
          <th class="tit_head" align="left" style="width: 40mm;">諸条件書</th>
            ...
            <table border="1" cellspacing="0" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>〒530-0027&emsp;大阪市北区堂山町18番2号</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>阪急線「大阪梅田」駅より徒歩約6分<br><span class="s_text">※他の沿線は『物件の図面』にて掲載</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="0">
                    <tr>
                      <td align="left" style="width: 98mm;">月曜～土曜　7:30～21:00（※開館は管理人、閉館は夜間巡回時。入居テナ<br>ント様が閉館作業いただける場合は変更可能）<br>日曜・祝日　10:00～22:00（※現在、入居テナント様が開閉されている為、時間調整は可能）<br>※お盆・正月に関しては、終日閉館となります。<br>※引越は、「土曜日（祝日以外）」のみとなります。</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="1">
                    <tr>
                      <td align="left" style="width: 101mm;">管理人定期巡回による警備（月～土　7：30～18：00実施。日祝なし）</td>
                    </tr>
                  </table>
                </td>
              </tr>
