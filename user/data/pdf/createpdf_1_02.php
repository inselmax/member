    ...
    <tr>
      <th>
        <table cellpadding="3" style="width: 190mm;">
          <tr>
            <th class="tit_head" align="right" style="width: 105mm;">若杉センタービル別館</th>　
    ...
    <tr>
      <td class="tbl_01" style="width: 80mm;">
        ...
        <td rowspan="2" align="center" style="width: 40mm; height: 31.5mm;">
            <img src="/member/user/data/pdf/sample/img02_01.jpg" style="height: 31.5mm;">
        </td>
...
<table border="0" cellspacing="0" cellpadding="2" style="width: 190mm;">
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">個別空調&emsp;※省エネ型空調機を使用</td>
    </tr>
    <tr>
      <th style="width: 35mm;">〇エレベーター</th>
      <td style="width: 150mm;" colspan="2">2基</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">2021年1月1日より全館禁煙（室内含む）とさせて頂きます。<br>電子タバコはご利用頂けますが、灰皿の設置はございませんので、各自で処理頂きますようお願いいたします。
      </td>
    </tr>
    <tr>
