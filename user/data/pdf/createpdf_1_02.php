  ...
  <tr>
    <td style="width: 132mm;">
      <table cellpadding="3" style="width: 132mm;">
        <tr>
          <th class="tit_head" align="right" style="width: 65mm;">若杉センタービル別館</th>　
          ...
          <td class="dotborder">
            ...
            <table border="0" cellspacing="0" cellpadding="2" style="width: 132mm;">
              <tr>
                ...
                <img src="/member/user/data/pdf/sample/image02_01.jpg" style="height: 63.5mm;">
                </td>
            ...
            <table border="1" cellspacing="0" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>〒530-0044&emsp;大阪市北区東天満2丁目8番1号</td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>JR東西線「大阪天満宮」駅9号出口より徒歩1分<br><span class="s_text">※他の沿線は『物件の図面』にて掲載</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
        ...
        <tr>
          <td>
            <table style="width: 132mm;" cellpadding="0" cellspacing="1">
              <tr>
                <td class="s_text">※「若杉センタービル別館駐車場」立体駐車場<br>※入出庫可能時間　月曜～土曜　7:30～21:30 　日曜・祝日・お盆・年末年始は入出庫不可<br>※サイズ：高さ1,650㎜×車幅1,850㎜×全長5,050㎜ 重量1,600㎏</td>
              </tr>
            </table>
          </td>
        </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="1">
                    <tr>
                      <td align="left" style="width: 98mm;">個別空調</td>
                    </tr>
                  </table>
                </td>
              </tr>
