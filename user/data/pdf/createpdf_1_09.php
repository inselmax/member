    ...
    <tr>
      <th>
        <table cellpadding="3" style="width: 190mm;">
          <tr>
            <th class="tit_head" align="right" style="width: 105mm;">若杉ビル</th>　
    ...
    <tr>
      <td class="tbl_01" style="width: 80mm;">
        ...
        <td rowspan="2" align="center" style="width: 40mm; height: 31.5mm;">
            <img src="/member/user/data/pdf/sample/img09_01.jpg" style="height: 31.5mm;">
        </td>
...
<table border="0" cellspacing="0" cellpadding="2" style="width: 190mm;">
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">月曜～土曜&emsp;7:30～21:00&emsp;時間外・日曜・祝日・お盆・年末年始はセキュリティカードにて出入りは可能です。</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width: 150mm;" colspan="2">ビルマルチ空調 （冷暖房の切り替えはビル側にて実施）</td>
    </tr>
    <tr>
