  ...
  <tr>
    <td style="width: 132mm;">
      <table cellpadding="3" style="width: 132mm;">
        <tr>
          <th class="tit_head" align="right" style="width: 51mm;">若杉ビル</th>　
          <th class="tit_head" align="left" style="width: 47mm;">諸条件書</th>
          ...
          <td class="dotborder">
            ...
            <table border="0" cellspacing="0" cellpadding="2" style="width: 132mm;">
              <tr>
                ...
                <img src="/member/user/data/pdf/sample/image09_01.jpg" style="height: 63.5mm;">
                </td>
            ...
            <table border="1" cellspacing="0" cellpadding="1" style="width: 132mm;">
              ...
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>大阪メトロ御堂筋線「中津」駅2番出口より徒歩1分<br><span class="s_text">※他の沿線は『物件の図面』にて掲載</span></td>
                    </tr>
                  </table>
                </td>
              </tr>
        ...
        <tr>
          <td>
            <table style="width: 132mm;" cellpadding="1" cellspacing="1">
              <tr>
                <td class="s_text">※1&emsp;年2回、ビル側で専有部内タイルカーペットの洗浄清掃を行います。上記金額は1回分の金額となり、原則年2回の床清掃を実施いたします。</td>
              </tr>
            </table>
          </td>
        </tr>
            ...
            <table border="1" cellpadding="1" style="width: 132mm;">
              <tr>
                ...
                <td style="width: 98mm;">
                  <table style="width: 98mm;" cellpadding="0">
                    <tr>
                      <td align="left" style="width: 98mm;">月曜～土曜　7:30～21:00<br>時間外・日曜・祝日・お盆・年末年始は、セキュリティカードにて出入可能。<br>※引越は、「土曜日（祝日以外）」のみとなります。</td>
                    </tr>
                  </table>
                </td>
              </tr>
